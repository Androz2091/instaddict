...
import { perfMonitor, getMemoryUsage } from './performance.js';

export async function extractData(files) {
    perfMonitor.start('total_extraction');
    ...
    perfMonitor.start('message_processing');
    ...
    perfMonitor.end('message_processing');
    perfMonitor.start('statistics_calculation');
    ...
    perfMonitor.end('statistics_calculation');
    perfMonitor.end('total_extraction');
