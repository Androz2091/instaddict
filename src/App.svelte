...
<main class="app">
	...
	<footer>
		<p>Développé par <a>Androz2091</a> et <a>open source</a>!</p>
	</footer>
</main>
...
<style lang="scss">
	...
	.app-loader-tuto {
		...
		text-decoration: none;
		text-align: center;
		background-color: rgba(var(--main-color-r), var(--main-color-g), var(--main-color-b), .1);
		display: block;
