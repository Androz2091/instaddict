<script>
	...
	import { data, loaded, loadTask } from './app/store';
...
<main class="app">
		...
		{#if !$loaded}
			<div class="app-loader">
				<div class="app-loader-boxes">
					...
					<div class="app-loader-upload" on:click="{filePopup}" >
	...
	<footer>
		<p>Made with ❤️ by <a href="https://twitter.com/Androz2091">Androz2091</a>. Instaddict is <a href="https://github.com/instaddict/instaddict.me">open source</a>!</p>
	</footer>
</main>
